...
public class ActivityProfile extends AppCompatActivity implements View.OnClickListener {
    ...
    private String nom, prenom, email, tele, date, adress, photo = "Non disponible";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.adress.setOnClickListener(this);
    ...
    public void updateUi(){
        ...
        binding.adressT.setText(adress);
        try {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.adress : {
                updateValeur("Adress", adress, "location");
                break;
            }
